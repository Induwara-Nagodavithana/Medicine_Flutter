        ...
        child: Column(
            children: <Widget>[
              ...
              ListTile(
                ...
                onTap: (){
                  Navigator.push(context,new MaterialPageRoute(builder: (context)=> new LocationPage()) );
                },
    ),
              ListTile(
                ...
                onTap: (){
                  Navigator.push(context,new MaterialPageRoute(builder: (context)=> new MedicineHistoryPage()) );
                },
